...
const StyledInput = styled.input`
    ...
    border: none;
    outline: none;
    border-bottom: ${({ background }) => background ? 'none' : `0.063rem solid ${text.mutedGray}`};
    padding-bottom: ${({ background }) => background ? '0.313rem' : '0.625rem'};
...
export const StyledMailInput = styled(StyledInput)`
